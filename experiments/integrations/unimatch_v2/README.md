# C-PGS UniMatch-V2 integration snapshot

> **Release note:** This directory is a C-PGS experimental modification derived from the official UniMatch-V2 codebase; it is not an unmodified upstream checkout. See `MODIFICATIONS.md` for scope and provenance and `LICENSE` for the retained upstream MIT terms. The upstream README is preserved below for attribution and usage context.

# Upstream UniMatch V2 README
