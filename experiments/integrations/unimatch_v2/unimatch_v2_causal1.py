...
# parser.add_argument('--a', default='0.6', type=float)
# parser.add_argument('--t', default='0.95', type=float)
cfg1 = {
...
# CUDA_VISIBLE_DEVICES=1 python unimatch_v2_causal1.py --config ./configs/AC.yaml --labeled-id-path ./data --unlabeled-id-path ./data --save-path ./1_8_3 --data 0.5 
...
def main():
    ...
    # # CUDA_VISIBLE_DEVICES=2 python unimatch_v2_causal1.py --config ./configs/AC.yaml --labeled-id-path ./data --unlabeled-id-path ./data --save-path ./1_4_New --data 0.5
